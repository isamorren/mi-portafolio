...
const Compositions = () => {
  ...
  const projects = [
    {
      ...
      gradient: "from-emerald-50 via-emerald-100 to-teal-50",
      icon: "🌱",
      color: "#10B981",
    ...
    },
    {
      ...
      gradient: "from-violet-50 via-violet-100 to-purple-50",
      icon: "✨",
      color: "#8B5CF6",
    ...
    },
    {
      ...
      gradient: "from-rose-50 via-rose-100 to-pink-50",
      icon: "📅",
      color: "#EC4899",
    ...
    },
    {
      ...
      gradient: "from-cyan-50 via-cyan-100 to-blue-50",
      icon: "📊",
      color: "#0EA5E9",
    ...
    },
    {
      ...
      gradient: "from-indigo-50 via-indigo-100 to-blue-50",
      icon: "🧘",
      color: "#6366F1",
    ...
    },
    {
      ...
      gradient: "from-fuchsia-50 via-fuchsia-100 to-pink-50",
      icon: "🎨",
      color: "#EC4899",
    ...
    },
    {
      ...
      gradient: "from-slate-50 via-slate-100 to-zinc-50",
      icon: "💎",
      color: "#6366F1",
  ...
  const ProjectCard = ({ project, index }: { project: typeof projects[0], index: number }) => (
    ...
    >
      ...
      <AnimatePresence>
        {hoveredProject === project.id && (
          <>
            ...
            {/* Film grain overlay */}
            <motion.div 
              className="absolute inset-0 opacity-30 mix-blend-overlay rounded-3xl pointer-events-none z-10"
              initial={{ opacity: 0 }}
              animate={{ opacity: 0.3 }}
              exit={{ opacity: 0 }}
              style={{
            ...
            <motion.div
              className="absolute inset-0 bg-gradient-to-r from-transparent via-white/5 to-transparent rounded-3xl pointer-events-none z-10"
              initial={{ x: '-100%' }}
              animate={{ x: '100%' }}
      ...
      {/* Main Card */}
      <motion.div
        className={`relative bg-gradient-to-br ${project.gradient} rounded-3xl p-8 shadow-xl border border-white/60 overflow-hidden backdrop-blur-sm`}
        whileHover={{ 
          scale: 1.03,
          y: -8,
          rotateY: 5,
        ...
        style={{
          ...
          boxShadow: hoveredProject === project.id 
            ? `0 20px 40px -10px ${project.color}40, 0 10px 25px -5px rgba(0, 0, 0, 0.1)`
      ...
      >
        ...
        <div className="flex items-start justify-between mb-6">
          <div className="flex-1">
            <motion.div 
              ...
              animate={{ 
                rotate: hoveredProject === project.id ? [0, -5, 5, -5, 0] : 0,
            ...
            <h3 className="font-serif-display text-2xl font-bold text-gray-800 mb-2">
              {project.title}
            </h3>
            <p className="font-script text-lg text-gray-600 italic leading-relaxed">
              "{project.verse}"
            </p>
          </div>
          ...
          <motion.div
            className="w-20 h-20 rounded-full bg-gradient-to-br from-gray-900 to-gray-700 relative flex-shrink-0 ml-4"
            animate={{ 
          ...
          >
            ...
            <div className="absolute inset-6 rounded-full bg-gradient-to-br from-red-800 to-red-900" />
        ...
        <div className="space-y-4 mb-8">
          <motion.div 
            className="border-l-3 border-gray-400/50 pl-4 hover:border-gray-600 transition-colors"
            whileHover={{ x: 4 }}
          >
            <p className="text-sm font-semibold uppercase tracking-wider text-gray-700 mb-1">Track 01: El problema</p>
          ...
          <motion.div 
            ...
            whileHover={{ x: 4 }}
          >
            <p className="text-sm font-semibold uppercase tracking-wider text-gray-700 mb-1">Track 02: La solución</p>
            ...
            <div className="flex flex-wrap gap-2">
              {project.tools.map((tool, i) => (
                <motion.span
                  ...
                  className="group/tech px-3 py-1.5 bg-white/70 backdrop-blur-sm rounded-full text-xs font-medium text-gray-700 border border-gray-300 hover:bg-white hover:border-gray-400 transition-all cursor-default flex items-center gap-1"
          ...
          <motion.div 
            ...
            whileHover={{ x: 4 }}
          >
            <p className="text-sm font-semibold uppercase tracking-wider text-gray-700 mb-1">Outro: Aprendizaje</p>
            <p className="text-gray-600 italic leading-relaxed">"{project.learning}"</p>
          </motion.div>
        </div>
        ...
        <motion.button
          ...
          className="w-full py-4 rounded-2xl font-semibold text-white relative overflow-hidden group/btn shadow-lg"
          style={{ 
        ...
        {/* Decorative elements */}
        <div 
          className="absolute -top-3 -right-3 w-10 h-10 rounded-full border-3 border-white/70 flex items-center justify-center"
        ...
        <div className="absolute top-0 left-0 w-full h-2 flex justify-around opacity-10">
          {[...Array(8)].map((_, i) => (
            <div key={i} className="w-3 h-2 bg-gray-800 rounded-sm" />
          ))}
        </div>
      </motion.div>
    </motion.div>
            ...
            >
              ...
              <div className={`bg-gradient-to-br ${project.gradient} p-8 rounded-t-3xl`}>
                ...
                <div className="text-center">
                  ...
                  <h3 className="font-serif-display text-3xl font-bold text-gray-800 mb-2">
                    {project.title}
                  </h3>
                  <p className="font-script text-xl text-gray-600 italic">
                    "{project.verse}"
                  </p>
                </div>
              </div>
              ...
              <div className="p-8 space-y-6">
                <div>
                  <h4 className="font-serif-display text-lg font-bold text-gray-800 mb-2">El desafío</h4>
                  <p className="text-gray-600 leading-relaxed">{project.problem}</p>
                </div>
                
                <div>
                  <h4 className="font-serif-display text-lg font-bold text-gray-800 mb-2">La solución creativa</h4>
                  <p className="text-gray-600 leading-relaxed">{project.solution}</p>
                </div>
                
                <div>
                  <h4 className="font-serif-display text-lg font-bold text-gray-800 mb-3">Stack tecnológico</h4>
                ...
                <div className="bg-gray-50 rounded-2xl p-6">
                  <h4 className="font-serif-display text-lg font-bold text-gray-800 mb-2">Reflexión final</h4>
                  <p className="text-gray-600 italic leading-relaxed">"{project.learning}"</p>
                </div>
                ...
                <div className="flex gap-4 pt-4">
                  <motion.a
                    ...
                    className="flex-1 py-3 rounded-xl font-semibold text-white text-center relative overflow-hidden group"
  ...
  return (
    <>
      <section id="compositions" className="py-32 px-6 relative overflow-hidden bg-[#FAFAFF]">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        >
          <h2 className="font-serif-display text-5xl md:text-7xl text-gray-800 mb-4">
            Mis <span className="font-script italic text-[#8B5CF6]">composiciones</span> digitales
          </h2>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Cada proyecto es una melodía única donde el código y el diseño danzan juntos
          </p>
          <motion.div 
            className="w-24 h-0.5 bg-gradient-to-r from-transparent via-[#8B5CF6] to-transparent mx-auto mt-6"
            initial={{ width: 0 }}
            ...
            <div className="flex items-center justify-center gap-8 mt-12">
              ...
              >
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                  <path d="M15 19l-7-7 7-7" stroke="#8B5CF6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </motion.button>
                ...
                {[...Array(totalPages)].map((_, i) => (
                  <motion.div
                    ...
                    className={`w-2 h-2 rounded-full transition-all duration-300 ${
                      i === currentPage ? 'w-8 bg-[#8B5CF6]' : 'bg-gray-300'
                    }`}
              ...
              >
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                  <path d="M9 5l7 7-7 7" stroke="#8B5CF6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </motion.button>
            </div>
          )}
        ...
        >
          <svg width="200" height="200" viewBox="0 0 200 200" fill="none">
            <circle cx="50" cy="50" r="40" stroke="#8B5CF6" strokeWidth="2"/>
            <circle cx="150" cy="50" r="40" stroke="#8B5CF6" strokeWidth="2"/>
            <rect x="30" y="90" width="140" height="80" stroke="#8B5CF6" strokeWidth="2" rx="10"/>
