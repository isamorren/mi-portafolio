...
export const metadata = {
  title: 'Introducción a Next.js 14: El futuro del desarrollo web | Isabel Moreno',
  description: 'Descubre las nuevas características de Next.js 14 y cómo pueden mejorar tu flujo de desarrollo con el App Router, Server Components y más.',
}
